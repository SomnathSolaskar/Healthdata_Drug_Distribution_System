...
CREATE TABLE "HCP" (
    "HCP_ID"        NUMBER(10, 0),
        "HCP_NAME"      VARCHAR2(255 BYTE) COLLATE "USING_NLS_COMP"
            NOT NULL ENABLE,
...
CREATE TABLE "PATIENT" (
    ...
    FOREIGN KEY ( "CLIENT_ID" )
        REFERENCES "ADMIN"."CLIENT" ( "CLIENT_ID" )
    ENABLE
) DEFAULT COLLATION "USING_NLS_COMP"
SEGMENT CREATION IMMEDIATE
PCTFREE 10 PCTUSED 40 INITRANS 10 MAXTRANS 255 NOCOMPRESS LOGGING
...
CREATE TABLE "CONTACT" (
    ...
    FOREIGN KEY ( "PATIENT_ID" )
        REFERENCES "ADMIN"."PATIENT" ( "PATIENT_ID" )
    ENABLE
) DEFAULT COLLATION "USING_NLS_COMP"
SEGMENT CREATION IMMEDIATE
PCTFREE 10 PCTUSED 40 INITRANS 10 MAXTRANS 255 NOCOMPRESS LOGGING
...
CREATE TABLE "CLAIMS" (
    ...
    FOREIGN KEY ( "PRESCRIPTION_ID" )
        REFERENCES "ADMIN"."PRESCRIPTION" ( "PRESCRIPTION_ID" )
    ENABLE
) DEFAULT COLLATION "USING_NLS_COMP"
SEGMENT CREATION IMMEDIATE
PCTFREE 10 PCTUSED 40 INITRANS 10 MAXTRANS 255 NOCOMPRESS LOGGING
...
CREATE TABLE "PRESC_MEDICINE" (
    ...
    FOREIGN KEY ( "MEDICINE_ID" )
        REFERENCES "ADMIN"."MEDICINES" ( "MEDICINE_ID" )
    ENABLE
) DEFAULT COLLATION "USING_NLS_COMP"
SEGMENT CREATION IMMEDIATE
PCTFREE 10 PCTUSED 40 INITRANS 10 MAXTRANS 255 NOCOMPRESS LOGGING
...
CREATE TABLE "ORDERS" (
    ...
    FOREIGN KEY ( "PHARMACY_ID" )
        REFERENCES "ADMIN"."PHARMACY" ( "PHARMACY_ID" )
    ENABLE,
    FOREIGN KEY ( "ORDER_MED_ID" )
        REFERENCES "ADMIN"."PRESC_MEDICINE" ( "ORDER_MED_ID" )
    ENABLE
) DEFAULT COLLATION "USING_NLS_COMP"
SEGMENT CREATION IMMEDIATE
PCTFREE 10 PCTUSED 40 INITRANS 10 MAXTRANS 255 NOCOMPRESS LOGGING
...
CREATE SEQUENCE Sequence_claim_id START WITH 7000 INCREMENT BY 1 NOCACHE NOCYCLE;